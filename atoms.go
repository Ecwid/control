...
const (
	...
	functionPreventMissClick     = `function(){tt=this,z=function(b){for(var c=b;c;c=c.parentNode)if(c==tt)return!0;return!1},i=function(b){if (z(b.target)) {_control_click("1")} else {b.stopPropagation();b.preventDefault();_control_click("0")}},document.addEventListener("click",i,{capture:!0,once:!0})}`
